...
const Startup = ({ onChallengeAction }) => {
    ...
    if (loading) {
        return (
            <div className="p-6 bg-white/50 rounded-2xl shadow-lg border border-white/80 flex justify-center items-center h-64">
    ...
    return (
        <motion.div
            ...
            className="p-6 bg-gradient-to-br from-green-50/50 to-teal-50/50 rounded-2xl shadow-lg border border-white/80 "
        >
