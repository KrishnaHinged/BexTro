...
const NotificationTray = ({ onClose }) => {
    ...
    const getIcon = (type) => {
        switch (type) {
            ...
            case "communityMessage": return <FaUsers className="text-indigo-500" />;
            default: return null;
        }
    };
                    ...
                    <div className="divide-y divide-gray-50">
                        {notifications.map((notif) => (
                            <div 
                                ...
                                className={`p-4 flex gap-3 hover:bg-gray-50 transition cursor-pointer ${!notif.isRead ? 'bg-indigo-50/30 font-medium' : ''}`}
                            >
