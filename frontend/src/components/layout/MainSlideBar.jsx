...
{authUser?.currentStreak > 0 && (
  <div className="mb-2 flex flex-col items-center group cursor-default" title={`🔥 ${authUser.currentStreak} Day Streak`}>
      <motion.div 
      ...
      <span className="text-[10px] font-black text-orange-600 -mt-1 tracking-tighter">
